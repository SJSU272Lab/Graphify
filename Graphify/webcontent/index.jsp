      ...
      <div class="carousel-inner">
        ...
        <div class="item" style="background-image: url(images/slider/2.jpg)">
          <div class="caption">
            ...
            <p class="animated fadeInRightBig">We create solutions</span></p>
            <a data-scroll class="btn btn-start animated fadeInUpBig" href="#services">Start now</a>
          </div>
        </div>
        <div class="item" style="background-image: url(images/slider/3.jpg)">
          <div class="caption">
            ...
            <p class="animated fadeInRightBig">We create tool to convert Boring Tabular DB to Attractive Graph DB</p>
            <a data-scroll class="btn btn-start animated fadeInUpBig" href="#services">Start now</a>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.jsp">
            <h1><img class="img-responsive" src="images/logo.png" alt="logo" height="50" width="50"></h1>
          </a>                    
        </div>
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">                 
            <li class="scroll active"><a href="#home">Home</a></li>
            <li class="scroll"><a href="#services">Gaphify Tool</a></li>
              ...
              <div data-role="popup" id="myPopup" class="ui-content" style="min-width:400px;">
                  <form id="fileForm" method="get" action="">
                      <div>
                          ...
                          <div id="dropzone" >
                            <input type="file" class="dropzone needsclick dz-clickable" id="demo-upload" name="file">
                          ...
                          <button id="btnUpload" data-inline="true" value="Submit">
      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="about-info wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
            <h2>About us</h2>
            <p>We group of four are highly enthusiastic coders and creaters, looking forward to develop something that will ease people to easily migrate the Tabular DataBase to the latest Graph DB </p>
        ...
        <div class="row">
          <div class="col-sm-3">
            <div class="team-member wow flipInY" data-wow-duration="1000ms" data-wow-delay="300ms">
              <div class="member-image">
                <img class="img-responsive" src="images/team/n.jpg" alt="">
              </div>
          ...
          <div class="col-sm-3">
            <div class="team-member wow flipInY" data-wow-duration="1000ms" data-wow-delay="500ms">
              <div class="member-image">
                <img class="img-responsive" src="images/team/sa.jpg" alt="">
              </div>
              <div class="member-info">
                <h3>Sohrab Ali</h3>
          ...
          <div class="col-sm-3">
            <div class="team-member wow flipInY" data-wow-duration="1000ms" data-wow-delay="800ms">
              <div class="member-image">
                <img class="img-responsive" src="images/team/sk.jpg" alt="">
              </div>
              <div class="member-info">
                <h3>Swathi Koduri</h3>
          ...
          <div class="col-sm-3">
            <div class="team-member wow flipInY" data-wow-duration="1000ms" data-wow-delay="1100ms">
              <div class="member-image">
                <img class="img-responsive" src="images/team/sv.jpg" alt="">
              </div>
              <div class="member-info">
                <h3>Sushant</h3>
                <h4>Backend</h4>
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="contact-info wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                ...
                <ul class="address">
                  <li><i class="fa fa-map-marker"></i> <span> Address:</span> SAN JOSE STATE UNIVERSITY </li>
                  <li><i class="fa fa-phone"></i> <span> Phone:</span> (707)-867-5867</li>
                  <li><i class="fa fa-envelope"></i> <span> Email:</span><a href="mailto:someone@yoursite.com"> we@gaphify.com </a></li>
                  <li><h3><i class="fa fa-globe"></i><span> Website:</span> <a href="#">www.graphify.com</a></h3></li>
                </ul>
              </div>                            
            </div>
          </div>
    ...
    <div class="footer-top wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
      <div class="container text-center">
        <div class="footer-logo">
          <a href="index.jsp"><img class="img-responsive" src="images/logo.png" alt="" height="60" width="60"></a>
        </div>
        <div class="social-icons">
          <ul>
